...
SYSTEM_RULES = load_system_rules(active_system())
...
class AIGameMaster:
    ...
    def load_adventure(self, adventure_name: str):
        ...
        # Load adventure JSON
        adventure_path = WORLD_STATE_DIR / f"{adventure_name}.json"
    ...
    async def run(self):
        ...
        if len(sys.argv) > 1:
            ...
            if adventures:
                ...
                print("No adventures found. Please add adventure PDFs to campaigns/dying_earth/adventures/")
                print("Then run: python -m gm_core.agents.pdf_ingestor to process them.")
...
def import_adventure(pdf_path: str, adventure_name: str):
    ...
    output_path = WORLD_STATE_DIR / f"{adventure_name}.json"
...
def import_character(pdf_path: str, character_name: str):
    ...
    output_path = CHARACTERS_DIR / f"{character_name}.json"
